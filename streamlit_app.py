...
if 'chat_initialized' not in st.session_state:
    ...
    st.session_state.system_template =   """
         ...
         לאמן אותם לזהות את הבעיה ובמידת הצורך לשכנע את המטופלת ללכת לקבל טיפול דחוף במיון.
            ...
            🟢 חוקי הדמות:
            אתה מטופלת בשם אנא, בת 32, אשר מצלצלת למוקד אחיות עם תלונה על כאב בטן תחתונה שבועיים לאחר ניתוח קיסרי.
...
def page_result():
    ...
    try:
        with st.spinner("מכין משוב..."):
            ...
            2.בדיקות קריטיות: פרט אילו בדיקות נערכו ואילו לא: חום, לחץ דם ודופק, אומדן פצע, 
               - "ווידאת איך נראה הפצע הניתוחי, אך פספסת לבדוק חום. זו בדיקה קריטית שהיית חייב לבצע."
            3. המטופלת סובלת 
