...
@retry(
    stop=stop_after_attempt(4),  # Maximum retries before failing
...
def import_llm_models():
    return ChatOpenAI(api_key=st.session_state.api_key, model="gpt-4o-mini", temperature=0.4) # gpt-4o-mini , gpt-4o
